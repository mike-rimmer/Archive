const wallaceDataAbridged = {
  title: 'Wallace List Intro',
  desc: 'This is a description of the Wallage List',
  intro: `
  <h1>Kingston Marine Museum of the Great Lakes</h1>
  <h1>is pleased to host the <span style='text-shadow: 4px 4px 5px black; color:white;'>The Wallace List Registry</span></h1>
<p>
<h3><b>Preface</b></h3>
...
export default wallaceDataAbridged
