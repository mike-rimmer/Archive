...
export default {
    ...
    methods:{
      ...
      //   tl.set('.box',{y:100, x:0})
      //   tl.to('.box',{opacity:1, scale:1, duration:3})
      //   tl.to('.box',{x:800, boxShadow:"5px 15px 15px grey", duration:4})
      //   tl.to('.sun',{x:1600, duration:10})
      //   tl.fromTo('.box',{ boxShadow:"5px 15px 15px grey"},
      //   {boxShadow:"-5px 5px 5px grey", duration:10},'-=10')
      //   this.gsaphandle = tl
      // },

      useHandle(){
        const tl = this.gsaphandle
        tl.to('.sun',{x:1600, duration:10})
        tl.fromTo('.box',{ boxShadow:"5px 15px 15px grey"},
        {boxShadow:"-5px 5px 5px grey", duration:10},'-=10')
      },
     ...
     enter(el){
      //  const Owl = document.querySelector('#wiseowl')
       console.log("enter called")
       const tl = gsap.timeline()
       tl.from(el,{y:-100, x:100, opacity:0, scale:0, duration:2})
       ...
       tl.from('#help',{y:-600, x:1, opacity:0, duration:1})
       tl.to(el, {y:0, x:0, opacity:1, scale:1, duration:2})
       tl.to('#eyes',{y:40, opacity:0, duration:2 })
       tl.to('#help',{y:-100, x:1, opacity:0, scale:0})
       tl.to(el,{opacity:.2, scale:.5, duration:.3})
    },
     ...
     showMrOwl(){
       ...
       const tl = gsap.timeline()
       tl.to('#Owl',{opacity:1, scale:1})
       tl.from('#eyes',{y:40, opacity:0, duration:2 },'+=.3')
       tl.from('#help', {y:-600, x:1, opacity:1, duration:1},'-=2')
       tl.to('#help',{y:-100, x:1, opacity:0, scale:0})
       },
