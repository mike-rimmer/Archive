<template>
  ...
  >
    ...
    <div>
      ...
      </p><p>{{ record.vesselName }}</p>
      <p>
        <span class="label">Vessel Date: </span>
        {{ record.vesselDate }}
      </p>
      <p>
      ...
      <p>
        <span class="label">Date Closed: </span>
        {{ record.dateClosed }}
      </p>
      <p>
        <span class="label">Reason Closed: </span>
        {{ record.reasonClosed }}
      </p>
      <p>
        <span class="label">PlaceClosed: </span>
        {{ record.placeClosed }}
      </p>
