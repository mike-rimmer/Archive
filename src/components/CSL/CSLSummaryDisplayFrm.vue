...
export default {
  ...
  data() {
    ...
    computed:{
    ...mapState('CSL', ['CSLCurrentFilter', 'CSLGlobal', 'CSLCart', 'CSLFilter', 'CSLCartIsLoading','CSLCurrentDetail', 'upDateDetailCart']),
  ...
  methods: {
    ...mapActions('CSL', ['loadCSLCurrentDetail','loadCSLCurrentDetailandUpDateDetailCart']),
